...
class Config extends AdminWeb{
  ...
  val connStepToComponnetCS_1_1: JsValue = Json.obj(
  ...
  val connStepToComponentSC_1_1 = handelMessage(connStepToComponnetCS_1_1)
  println(s"ConnStepToComponent_1_1   Client -> Server: $connStepToComponnetCS_1_1")
  println(s"ConnStepToComponent_1_1   Server -> Client: $connStepToComponentSC_1_1")
  ...
  val connStepToComponnetCS_1_2: JsValue = Json.obj(
      "jsonId" -> DTOIds.connStepToComponen,
      "dto" -> DTONames.connSteptoComponent,
      "params" -> Json.obj(
          "adminId" -> (loginSC \ "result" \ "adminId").asOpt[String].get,
  ...
  val connStepToComponentSC_1_2 = handelMessage(connStepToComponnetCS_1_2)
  println(s"ConnStepToComponent_1_2   Client -> Server: $connStepToComponnetCS_1_2")
  println(s"ConnStepToComponent_1_2   Server -> Client: $connStepToComponentSC_1_2")
  ...
  //###Connect Component 3 -> Step 1
  val connStepToComponnetCS_1_3: JsValue = Json.obj(
      "jsonId" -> DTOIds.connStepToComponen,
      "dto" -> DTONames.connSteptoComponent,
      "params" -> Json.obj(
          "adminId" -> (loginSC \ "result" \ "adminId").asOpt[String].get,
  ...
  val connStepToComponentSC_1_3 = handelMessage(connStepToComponnetCS_1_3)
  println(s"ConnStepToComponent_1_3   Client -> Server: $connStepToComponnetCS_1_3")
  println(s"ConnStepToComponent_1_3   Server -> Client: $connStepToComponentSC_1_3")
